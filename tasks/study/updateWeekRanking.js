...
const sql = {
	...
	allTotalDesc: (guildId) => new Promise((resolve, reject) => {
		...
		startDay.setHours(0); startDay.setMinutes(0); startDay.setSeconds(0); startDay.setMilliseconds(0);
		endDay.setDate(today.getDate() + (6 - today.getDay()));
		endDay.setHours(23); endDay.setMinutes(59); endDay.setSeconds(59); endDay.setMilliseconds(999);
